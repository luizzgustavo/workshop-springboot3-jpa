...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product p1 = new Product(null, 90.5, "Lorem ipsum dolor sit amet, consectetur.", "The Lord of the Rings", null);
        ...
        Product p5 = new Product(null, 100.00, "Cras fringilla convallis sem vel faucibus.", "Rails for Dummies", null);
